...
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-900 mt-2">Editar categoría</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('tenant.category.update', ['tenant' => $tenant, 'category' => $category->id]) }}" class="space-y-5">
            @csrf @method('PATCH')
            <div>
