...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-sm">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-400 text-sm mt-1">Panel de SuperAdmin</p>
    </div>
    ...
    <form method="POST" action="{{ route('superadmin.login.post') }}">
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="{{ old('email') }}" autofocus
                   class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400
